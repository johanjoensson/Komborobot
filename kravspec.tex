...
Komboroboten ska vara moduluppbyggd och bestå av en kommunikationsenhet, en styrenhet och en sensorenhet.
...
\begin{LIPSkravlista}
  ...
  \LIPSkrav{Original}{Roboten ska bestå av minst tre moduler, styrenhet, kommunikationsenhet och sensorenhet}{1}
\end{LIPSkravlista}
...
\begin{LIPSkravlista}
	...
	\LIPSkrav{Original}{Styrenheten ska kunna bytas utStyrenheten ska kunna bytas ut}{1}
\end{LIPSkravlista}

\subsection{Funktionella krav}
\begin{LIPSkravlista}
  \LIPSkrav{Original}{Roboten ska följa en linje eller en korridor specificerad enligt Appendix A utan att slingra sig fram}{2}
...
\begin{LIPSkravlista}
  ...
  \LIPSkrav{Original}{Kommunikationsenheten ska skicka data från datorn till lämplig modul, exempelvis navigationsinstruktioner skickas till styrenheten}{1}
\end{LIPSkravlista}

\subsection{Externa interface}
Kommuniaktionsenheten ska kommunicera med övriga moduler på roboten samt datorn och förmedla information mellan dessa.
...
\begin{LIPSkravlista}
  ...
  \LIPSkrav{Original}{Sensormodulen ska vara utbytbar}{1}
\end{LIPSkravlista}
...
\begin{LIPSkravlista}
  \LIPSkrav{Original}{Sensorenheten ska kunna läsa av markeringar på marken (se banspecifikation för tydligare beskrivning av markeringar)}{1}
\end{LIPSkravlista} 
...
\subsection{Designkrav}
\begin{LIPSkravlista}
  \LIPSkrav{Original}{Mjukvaran ska designas på så sätt att man enkelt kan anpassa den ifall någon av robotens moduler byts ut}{1}
\end{LIPSkravlista}
...
\begin{LIPSkravlista}
  ...
  \LIPSkrav{Original}{Datormjukvaran ska visa information från robotens olika moduler}{1}
  \LIPSkrav{Original}{Datormjukvaran ska via ett grafiskt användargränssnitt visa information från robotens olika moduler}{2}
\end{LIPSkravlista}
...
\begin{LIPSkravlista}
  \LIPSkrav{Original}{Roboten ska ta sig igenom en bana som uppfyller banspecifikationen för den nivå som bestämts}{1}
\end{LIPSkravlista}


\section{Krav på vidareutveckling}
\begin{LIPSkravlista}
  \LIPSkrav{Original}{Samtliga av de olika modulerna på roboten ska ha väl specificerade gränssnitt}{1}
  \LIPSkrav{Original}{Det ska på ett enkelt vis vara möjligt att byta ut enskilda moduler på roboten}{1}
\end{LIPSkravlista}

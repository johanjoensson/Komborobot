...
/*******************************************************************************
*Trim funktionerna ökar hastigheten på höger respektive vänster hjul.
*Funktionen läggs på i set speed.
*******************************************************************************/
void trim_left()
{
		if(trim>-16){
...
/*******************************************************************************
*Speed dubblas för att ge ett större omfång som man kan reglera hastigheten i
*från 0-F till 0-1E. hastigheden kommer sedan att adderas upp till rätt nivå
*och retuneras till styrfunktionen.
*******************************************************************************/
void set_speed(unsigned char speed)
{
		...
		if (trim > 0){
			speed_right = speed - 2;			
			speed_left = speed + (2+trim);		
		}
		else{
			speed_right = speed - (2+trim);		
			speed_left = speed + 2;				
		}
}

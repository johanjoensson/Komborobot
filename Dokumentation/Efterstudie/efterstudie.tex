...
\newcommand{\LIPSgranskare}{simla804}
\newcommand{\LIPSgranskatdatum}{2012-05-30}
...
\LIPSversionsinfo{1.0}{2012-05-30}{Stolpar utvecklade till text.}{MJ,MF,SL,JJ,GS}{simla804}
\end{LIPSdokumenthistorik}
\newpage

\section{Inledning}
Denna studie är en sammanfattning av hur grupp 17, bestående de sju projektmedlemarna vars namn anges på sida 2, arbetat med projektkursen "Elektronikprojekt Y" under vårterminen 2012 samt vilka erfarenheter och lärdomar som kunnat dras av det. Under projektet har gruppen konstruerat en s.k. Komborobot, vilket i stora drag innebär en robot som autonomt kan ta sig fram sig genom en bana bestående dels av en upptejpad linje på golvet (linjen har mörkare färg än underlaget), dels en labyrint uppbyggd av 80 centimeter långa väggmoduler.

Som grund för denna efterstudie ligger ett utvärderingsmöte där samtliga gruppmedlemmar under knappt två timmar diskuterade berörda punkter.
\section{Tidsåtgång}
Från det att "underfasen"\ av projektet (se avsnitt 3.1) inleddes med att gruppen framställde en designspecifikation för roboten fram till projektets slutförande fanns en tidsbudget på 140 timmar per gruppmedlem.

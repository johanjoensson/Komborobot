...
\LIPSversionsinfo{0.2}{2012-01-30}{Andra utkast.}{marlo265}{}
=======
  \LIPSversionsinfo{0.1}{2012-01-26}{FÃ¶rsta utkast.}{matja307}{}
  \LIPSversionsinfo{0.2}{2012-01-30}{Andra utkast.}{matja307}{johjo939}
  \LIPSversionsinfo{1.0}{2012-01-31}{FÃ¶rsta versionen}{gussv666}{johjo939}
>>>>>>> db89843d6b239e4d3cfac94a87554ad98e6f76b3
...
\subsection{MÃ¥l}
I samband med leveransen ska roboten klara av att under tÃ¤vling helt autonomt navigera
en bana som Ã¤r uppbyggd enligt bestÃ¤mmelserna i den bifogade banspecifikationen \ref{app:bana}. 
 TÃ¤vlingen avgÃ¶rs pÃ¥ tid, den robot som tar sig runt banan pÃ¥ kortast tid vinner.
>>>>>>> db89843d6b239e4d3cfac94a87554ad98e6f76b3
...
=======
\item PrioritetsnivÃ¥ 1 - Dessa krav ska uppfyllas
\item PrioritetsnivÃ¥ 2 - Dessa krav ska uppfyllas i mÃ¥n av tid
\item PrioritetsnivÃ¥ 3 - Dessa krav ska uppfyllas i mÃ¥n av tid och efter alla krav med prioritet 2 uppfyllts
>>>>>>> db89843d6b239e4d3cfac94a87554ad98e6f76b3
\end{itemize}
...
=======
  \LIPSkrav{Original}{Roboten ska kunna styras med blÃ¥tand}{1} 
  \LIPSkrav{Original}{Roboten ska kunna kÃ¶ra autonomt genom en bana enligt \ref{app:bana}}{1}
  \LIPSkrav{Original}{Val mellan fjÃ¤rrstyrnings- och autonomt lÃ¤ge ska styras med en brytare}{1}
  \LIPSkrav{Original}{Roboten ska ha en knapp som startar den i tÃ¤vlingen}{1}
  \LIPSkrav{Original}{Roboten ska bestÃ¥ av minst tre enheter, styrenhet, kommunikationsenhet och sensorenhet}{1}
>>>>>>> db89843d6b239e4d3cfac94a87554ad98e6f76b3
\end{LIPSkravlista}
...
<<<<<<< HEAD
  ...
  \LIPSkrav{Original}{Sensorenhetens linjeföljarsensor ska kunna kalibreras}{1}
   \LIPSkrav{Original}{Sensorenhetens linjeföljarsensor ska kunna kalibreras trådlöst via bluetooth}{2}
=======
  \LIPSkrav{Original}{Sensordata fÃ¶r avstÃ¥nd till vÃ¤ggarna pÃ¥ sidan om roboten skall samlas in}{1}
  \LIPSkrav{Original}{Sensordata frÃ¥n linjefÃ¶ljarsensor ska kunna mÃ¤rka skillnader mellan golv och svart tejp pÃ¥ marken}{1}
  \LIPSkrav{Original}{Sensorenhetens linjefÃ¶ljarsensor ska kunna kalibreras}{1}
   \LIPSkrav{Original}{Sensorenhetens linjefÃ¶ljarsensor ska kunna kalibreras trÃ¥dlÃ¶st via bluetooth}{2}
>>>>>>> db89843d6b239e4d3cfac94a87554ad98e6f76b3
\end{LIPSkravlista}
...
=======
  \LIPSkrav{Original}{Information om robotens styrbeslut skall kontinuerligt visas pÃ¥ en datorskÃ¤rm}{1}
  \LIPSkrav{Original}{FÃ¶rstÃ¥elig information frÃ¥n sensorenheten skall kontinuerligt visas pÃ¥ en datorskÃ¤rm}{1}
  \LIPSkrav{Original}{AvstÃ¥ndet till vÃ¤ggarna skall redovisas i cm pÃ¥ en datorskÃ¤rm}{2}
>>>>>>> db89843d6b239e4d3cfac94a87554ad98e6f76b3
\end{LIPSkravlista}
...
=======
	\LIPSkrav{Original}{Roboten ska ta sig igenom en bana av nivÃ¥ 1 som definieras i banspecifikationen (\ref{app:bana})}{1}
        \LIPSkrav{Original}{Roboten ska ta sig igenom en bana av nivÃ¥ 2 som definieras i banspecifikationen (\ref{app:bana})}{2}
	\LIPSkrav{Original}{Roboten ska ta sig igenom en bana av nivÃ¥ 3 som definieras i banspecifikationen (\ref{app:bana})}{3}
\end{LIPSkravlista}



\section{Krav pÃ¥ vidareutveckling}
>>>>>>> db89843d6b239e4d3cfac94a87554ad98e6f76b3
\begin{LIPSkravlista}
...
=======
Efter att projektet har passerat BP2 fÃ¥r totalt 980 timmar (140 timmar per projektmedlem) brukas.
>>>>>>> db89843d6b239e4d3cfac94a87554ad98e6f76b3
...
=======
	\LIPSleverans{Original}{Teknisk Dokumentation och anvÃ¤ndaranvisning}{3 arbetsdagar fÃ¶re redovisningen v20}{1}
>>>>>>> db89843d6b239e4d3cfac94a87554ad98e6f76b3
...
=======
Linjerna i banan skall bestÃ¥ av svart tejp pÃ¥ grÃ¥tt underlag. Tejpens bredd ska vara mellan 14-18 mm. I de fall dÃ¥ en tjock linje nÃ¤mns avses en tejplinje med bredd mellan 42-54 mm (tre tejpbredder). Med en smal tejplinje avses en linje med bredd 14-18 mm (en tejpbredd). Tejpbanan kan korsa sig sjÃ¤lv i 90\degree korsningar, den kan dock ej dela sig. SvÃ¤ngradien fÃ¶r banan Ã¤r minst 25 cm. Banan avslutas med en stoppsignal, tvÃ¥ tjocka tvÃ¤rgÃ¥ende linjer, eller Ã¶vergÃ¥r till en labyrint.
>>>>>>> db89843d6b239e4d3cfac94a87554ad98e6f76b3
...
=======
\item NivÃ¥ 1: AvstÃ¥ndet mellan parallella vÃ¤ggar Ã¤r 80 cm. 3-vÃ¤gskorsningar och 4-vÃ¤gskorsningar kan fÃ¶rekomma, dock med rÃ¤ta vinklar mellan varandra, rÃ¤tt vÃ¤g anges av markeringar pÃ¥ golvet. Markeringarna gÃ¶rs med tvÃ¥ linjer som gÃ¥r vinkelrÃ¤tt mellan vÃ¤ggarna. En tjock linje fÃ¶ljd av en tunn indikerar hÃ¶ger, en tunn fÃ¶ljd av en tjock indikerar vÃ¤nster och tvÃ¥ tunna linjer indikerar rakt fram. 
\item NivÃ¥ 2: Som nivÃ¥ 1 med fÃ¶ljande justeringar: Inga markeringar behÃ¶vs dÃ¥ ena vÃ¤gen vid en korsning Ã¤r en Ã¥tervÃ¤ndsgrÃ¤nd med djup pÃ¥ 80 cm.
\item NivÃ¥ 3: Som nivÃ¥ 1 med fÃ¶ljande justeringar: Inga markeringar nÃ¶dvÃ¤ndiga. HÃ¥l 80 cm stora ut ur labyrinten som inte leder nÃ¥gonstans kan fÃ¶rekomma.
>>>>>>> db89843d6b239e4d3cfac94a87554ad98e6f76b3
\end{list} 

...
till kommunikationsenheten via blåtand. Kommuniktionsenheten kommer därefter
behandla de två byten precis som alla andra.

Då kommunikationsenheten sänder data till PC-mjukvran kommer mjukvaran att
översätta header-bytem samt data-byten så att man enkelt kan åskådliggöra
instruktonen som sändes.

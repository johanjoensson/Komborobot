...
\input{protokoll.tex} % #3 - Protokoll
\input{teori.tex} % #4 -Regleralgoritmer etc.
\input{systemet.tex} % #5 -Blockschema och allmänt om systemet i sin helhet
\input{modulerna.tex} % #6 -Detaljerat om varje modul
	%% Innehåller komm.tex, pcmjuk.tex, sensor.tex, styr.tex
\input{slutsats.tex} % #7 -Förbättringspotential etc.
\input{referenser.tex} % #8 -Referenser

...
\newcommand{\LIPSdokumenttyp}{Teknisk Dokumentation, Komborobot}
\newcommand{\LIPSredaktor}{Simon Larsson}
\newcommand{\LIPSversion}{1.0}
\newcommand{\LIPSdatum}{\dagensdatum}

\newcommand{\LIPSgranskare}{Mattias Jansson}
...
\begin{LIPSdokumenthistorik} 
  \LIPSversionsinfo{1.0}{2012-05-10}{Version 1.0}{Grupp 17}{Mattias Jansson}

...
Milstolpar för projektet bestäms inom gruppen, och sätts för att kunna kontrollera att tidsplanen följs som planerat. Varje milstolpe innefattar ett eller flera krav som ska vara uppfyllda och testade vid det datum som specifierats nedan. Beslutspunkter är krav uppsatta från beställaren. Om beställaren anser att projektgruppen inte uppnått förväntade mål vid en beslutspunkt kan han besluta att projektet läggs ned.
